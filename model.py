...
class ConvVAE(nn.Module):
    def __init__(self, device='cuda', img_channels=3, args=None, img_size=28):
        super().__init__()
        ...
        if self.model == 'sigma_vae':
            ...
            self.log_sigma = torch.nn.Parameter(torch.zeros((1,)[0]), requires_grad=args.model == 'sigma_vae')
